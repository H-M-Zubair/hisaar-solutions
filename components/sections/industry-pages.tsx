      ...
      <section className="relative">
        ...
        <div className="mx-auto grid max-w-[1120px] gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-16">
            {g.pains.map((p, i) => (
              <AwesomeFade key={p.title} direction="right" delay={i * 80}>
          ...
          <ol className="relative border-l border-pharmacy/40 pl-8">
            {ticks.map((t, i) => (
              <li key={t} className="relative mb-14 last:mb-0">
                <AwesomeFade direction="left" delay={i * 90}>
      ...
      <section className="border-y border-line bg-surface">
        <div className="mx-auto max-w-[1120px] px-5 py-16 sm:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            {p.pains.map((item, i) => (
              <AwesomeFade key={item.title} direction={i % 2 === 0 ? "left" : "right"}>
                <article>
          ...
          <AwesomeFade direction="up" delay={80}>
  ...
  return (
    <>
      ...
      <section className="border-b border-line">
        ...
        <div className="flex">
          {swatches.map((s, i) => (
            <AwesomeFade key={s.n} direction="up" delay={i * 60} className="flex-1">
              <div className="h-16 sm:h-24" style={{ background: s.c }} title={s.n} />
            </AwesomeFade>
          ))}
        </div>
      </section>
