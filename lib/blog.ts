...
export const posts: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "What we will not do is stitch a second industry into the same organisation. Chains, FBR, white-label receipts, and unlimited tills are Pro+ Custom — from Rs 12,500 / month, quoted when the work is real. Honest product pages convert better than a logo wall of shops we do not have.",
    ],
  },
  {
