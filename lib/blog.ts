...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      "That is why Omni Ledger keeps the counter complete on Starter and on Pro. If you take the till away, the shopkeeper goes back to the copy book and never converts. The lock belongs on history, margin, extra seats, loyalty, bulk import, and the industry extras — lots, tables, the size×color matrix.",
  ...
  },
  {
    ...
    body: [
      ...
      "That queue is on Starter. Gating offline to a higher plan would be a good way to make a shopkeeper angry at 8pm in August. Pakistan’s internet is not a SLA. The till cannot be.",
  ...
  },
  {
    ...
    body: [
      ...
      "Starter is deliberately simple SKU. A takeaway counter does not need a table grid. A stall selling one cut of cloth does not need a matrix. A small medical store can bill by name. We say this on the industry pages because selling the wrong plan is how you lose the shop in month two.",
      "Pro is where the pack lives. If you legally need expiry lots, Starter is the wrong conversation — we will tell you on WhatsApp before we provision. If you have eight tables, we trial Pro, not a grocery skin. If your rail is S–XXL in four colours, the matrix comes out on day one of the demo.",
      "What we will not do is stitch a second industry into the same organisation, or sell a chain login. That slot is Pro+, and it is empty on purpose. Honest product pages convert better than a logo wall of shops we do not have.",
    ],
  },
  {
