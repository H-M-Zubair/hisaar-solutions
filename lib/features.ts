export const modules = [
  ...
  },
  {
    id: "udhaar",
    title: "Udhaar / credit",
    body: "Credit and partial on the ticket. Record Payment when they settle. Khata stays on Starter because grocery without it feels unfinished.",
  },
  {
    id: "shifts",
  ...
  },
  {
    id: "reports",
    title: "Owner reports",
    body: "Today on Starter. Week, month, year, charts, hourly rush, top SKUs, and CSV on Pro. The till does not get this pane.",
  },
];
