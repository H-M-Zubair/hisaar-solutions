export const plans = [
  ...
  },
  {
    ...
    points: [
      ...
      "Shift closing logs: cash in drawer vs POS sales",
  ...
  },
  {
    ...
    points: [
      ...
      "Loyalty, bulk import, multi-cashier shift history",
...
export const matrix: { feature: string; trial: string; starter: string; pro: string }[] = [
  ...
  { feature: "Shift closing logs — cash in drawer vs POS", trial: "Full", starter: "Full", pro: "Full" },
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Yes. Starter includes the shift closing summary: cash in the drawer versus POS cash sales. That is how you catch a shortage without buying Pro. Pro adds date and cashier filters across many closes — not the close itself.",
  },
  {
